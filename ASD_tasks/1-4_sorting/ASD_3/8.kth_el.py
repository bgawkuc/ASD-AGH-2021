...
#zwraca indeks mediany, w przedziale [l,r] w A
def median(A,l,n): #n-rozmiar przedziału
    r = n + l - 1
    insertionSort(A,l,r)
    return l + (n-1) // 2 

#znajduje mediane median
...
#na podstawie mediany median znajduje element, który będzie pivotem
