...
# Indeksy 0-n-1 oznaczają, ze do i-tego wierzchołka jechała Ala.
# Indeksy n-2n-1 oznaczają, ze do i-tego wierzchołka jechał Bob.
# Do kolejki wrzucam informacje kto prowadził do danego wierzchołka.
# Jeśli przez daną krawędź prowadzi Bob to liczę jej wartosć jako 0 - minimalizuje trasę Ali.
